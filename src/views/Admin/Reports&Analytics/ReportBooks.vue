    ...
    <header class="report-header">
      ...
      <div class="header-left">
        ...
        <h1 class="header-title">
          Library <span style="color:#f9a825">Book Analytics</span>
        </h1>

        <p class="header-sub">
          Import accession records to visualize library acquisitions,
          withdrawals, and subject distribution.
        </p>
    ...
    <section class="panel">
      ...
      <div class="panel-head">
        ...
        <div>
          ...
          <p class="panel-sub">
            Upload XLSX, XLS, or CSV to populate analytics
          </p>
        </div>
...
const newlyAcquired=[
 {accNo:'24-1101',title:'Artificial Intelligence',author:'Russell',subject:'Computer Science'},
 {accNo:'24-1102',title:'Design Patterns',author:'Gamma',subject:'Engineering'}
]

const deAccessioned=[
 {accNo:'98-0042',title:'BASIC Programming',author:'Norton',subject:'CS',dateRemoved:'Feb 12 2026'},
 {accNo:'97-0118',title:'Britannica Vol.3',author:'Various',subject:'Reference',dateRemoved:'Feb 20 2026'}
]
