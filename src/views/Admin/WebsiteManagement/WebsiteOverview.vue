  ...
  <div class="flex-1 py-10 px-6 md:pl-8 md:pr-16" style="font-family:'Poppins',sans-serif">
      ...
      <div class="bg-white rounded-3xl shadow-lg p-10">
        ...
        <div class="flex justify-between items-center mb-8">
          ...
          <button
            ...
            class="px-6 py-3 bg-orange-400 text-white rounded-xl font-bold hover:bg-orange-500 transition">
            Add Slide
          </button>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          <div
            ...
            <div class="w-40 h-24 bg-gray-200 rounded-xl flex items-center justify-center text-xs text-gray-500">
              Slide {{n}} Preview
            </div>
            ...
            <button
              ...
              class="px-5 py-2 bg-[#0B2010] text-white rounded-lg text-sm hover:bg-orange-500 transition">
              Edit
            </button>
    ...
    <section v-if="activeSection==='cards'" class="animate-fade-in">
      ...
      <div class="bg-white rounded-3xl shadow-lg p-10">
        ...
        <h4 class="font-black text-xl mb-8">
          Feature Cards
        </h4>
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          <div
            ...
            <div class="w-20 h-20 bg-white shadow rounded-2xl mb-6 flex items-center justify-center text-green-700">
    ...
    <section v-if="activeSection==='about'" class="animate-fade-in">
      ...
      <div class="bg-white rounded-3xl shadow-lg p-10">
        ...
        <div class="aspect-[21/9] bg-gray-200 rounded-3xl flex items-center justify-center relative group overflow-hidden">
          ...
          <div class="absolute inset-0 bg-white/80 opacity-0 group-hover:opacity-100 flex items-center justify-center transition">

            <button
              @click="goToEditor('About Banner','about-bg.jpg')"
              class="px-8 py-4 bg-orange-400 text-white font-bold rounded-xl hover:bg-orange-500 transition">
              Replace Banner
            </button>
