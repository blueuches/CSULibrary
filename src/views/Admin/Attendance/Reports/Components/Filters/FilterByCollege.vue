<template>
	<section class="rounded-2xl border border-[#c2d4cb] bg-white p-5">
		<h3 class="text-sm font-semibold uppercase tracking-widest text-[#0d2b0f]">BY COLLEGE Filters</h3>

		<div class="mt-4 space-y-4">
			<div>
				<label class="text-xs font-semibold uppercase tracking-widest text-[#4a7060]">College</label>
				<select
			...
			<div>
				<label class="text-xs font-semibold uppercase tracking-widest text-[#4a7060]">Program (Optional)</label>
				<select
