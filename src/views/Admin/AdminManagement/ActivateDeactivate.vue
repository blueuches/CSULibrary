<template>
  <div class="flex h-screen w-full overflow-hidden bg-[#f0f4f1]">
    ...
    <main class="page-root pl-6 mt-5 flex-1 overflow-y-auto">
      ...
      <!-- HEADER -->
      <div class="-mt-2">
        <AdminPageHeader :breadcrumbs="[{ label: 'Back', to: '/admin/management' }, 'Admin Management']" title="User Access">
          <template #subtitle>Activate or deactivate user accounts in the system.</template>
        </AdminPageHeader>
      </div>
