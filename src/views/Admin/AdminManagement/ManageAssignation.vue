<template>
  <div class="flex h-screen w-full overflow-hidden bg-[#f0f4f1]">
    ...
    <main class="report-root flex-1 overflow-y-auto">
      ...
      <!-- HEADER -->
      <AdminPageHeader :breadcrumbs="[{ label: 'Back', to: '/admin/management' }, 'Reports & Analytics']" title="Library Report">
        <template #subtitle>Generate and review reports by department, course, and duration.</template>
      </AdminPageHeader>
