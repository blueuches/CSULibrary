    ...
    <main class="report-root flex-1 overflow-y-auto">
      ...
      <section class="panel">
        ...
        <div v-if="currentStep === 0">
          <div class="panel-head">
            <div>
              ...
              <p class="panel-sub">Upload XLSX or XLS file containing CSU students</p>
            </div>
          </div>

          <label class="drop-zone">
            <input type="file" hidden accept=".xlsx,.xls" @change="handleFileUpload" />

            <p class="upload-main"><strong>Click or drag</strong> Excel file here</p>

            <p class="upload-sub">Supported formats: .xlsx, .xls</p>
          </label>
        </div>
        ...
        <div v-if="currentStep === 1">
          <div class="panel-head">
            <div>
              ...
              <p class="panel-sub">Confirm the records detected from the file</p>
            </div>
          </div>
          ...
          <table class="report-table">
            <tbody>
              ...
              <tr>
                <td>Status</td>
                <td class="text-right" style="color: #16a34a">Ready for Import</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div v-if="currentStep === 2">
          <div class="panel-head">
            <div>
              ...
              <p class="panel-sub">
                This will update the <strong>students</strong> table using the uploaded dataset.
              </p>
            </div>
          </div>

          <button class="import-btn" @click="importStudents">Import Students</button>
        </div>
        ...
        <div class="step-controls">
          ...
          <button v-if="currentStep < 2" class="nav-btn primary" @click="currentStep++">
            Continue
          </button>
        </div>
      </section>
