  ...
  <div class="w-full min-h-screen font-['Poppins'] bg-[#f7f5f0] pb-20 pt-[40px] relative overflow-hidden">
    ...
    <div class="w-full px-4 sm:px-8 lg:px-12 relative z-10">
      ...
      <div class="page-header mb-12">
        ...
        <h1 class="text-4xl sm:text-5xl font-bold text-[#1a2e1a] leading-tight tracking-tight mb-4">
          Digital Records
        </h1>
        <div class="w-16 h-[3px] bg-gradient-to-r from-[#1b5e20] to-[#66bb6a] rounded-full mb-5"></div>
        <p class="text-[15px] text-[#555] leading-relaxed max-w-xl font-light">
          Your gateway to institutional archives, digital collections, and academic resources — organized, accessible, and always available.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
        ...
        <!-- DATA UPLOAD -->
        <div class="record-card group flex flex-col w-full h-full bg-white rounded-xl overflow-hidden border border-[#1b5e20]/10 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300">
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <a
              href="https://drive.google.com/drive/folders/10VykxJ5P2C_OwVsF0Ym_ef4TUuFdq9I6"
              target="_blank"
            ...
            >
              <span class="relative z-10">Go to Data Upload</span>
              <svg class="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="record-card group flex flex-col w-full h-full bg-white rounded-xl overflow-hidden border border-[#1b5e20]/10 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300">
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <a
              ...
              class="record-btn group/btn relative flex items-center justify-between px-4 py-2.5 bg-[#1b5e20] text-white text-[12px] font-semibold tracking-wider uppercase font-['Poppins'] rounded-lg overflow-hidden transition-all duration-300 hover:bg-[#2e7d32]"
            >
              <span class="relative z-10">Download CD-ROM</span>
              <svg class="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="record-card group flex flex-col w-full h-full bg-white rounded-xl overflow-hidden border border-[#1b5e20]/10 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300">
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <a
              href="https://drive.google.com/drive/folders/1-2P2uJiziZHND_8gH5-d20uDmAiPs5gt"
              target="_blank"
              class="record-btn group/btn relative flex items-center justify-between px-4 py-2.5 bg-[#1b5e20] text-white text-[12px] font-semibold tracking-wider uppercase font-['Poppins'] rounded-lg overflow-hidden transition-all duration-300 hover:bg-[#2e7d32]"
            >
              <span class="relative z-10">Go to E-books</span>
              <svg class="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </a>
        ...
        <div class="record-card group flex flex-col w-full h-full bg-white rounded-xl overflow-hidden border border-[#1b5e20]/10 shadow-sm hover:shadow-2xl hover:-translate-y-1.5 transition-all duration-300">
          ...
          <div class="p-6 flex flex-col flex-grow">
            ...
            <RouterLink
              ...
              class="record-btn group/btn relative flex items-center justify-between px-4 py-2.5 bg-[#1b5e20] text-white text-[12px] font-semibold tracking-wider uppercase font-['Poppins'] rounded-lg overflow-hidden transition-all duration-300 hover:bg-[#2e7d32]"
            >
              <span class="relative z-10">Go to E-Resources</span>
              <svg class="w-4 h-4 relative z-10 group-hover/btn:translate-x-1 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </RouterLink>
